...
void HelloTriangleApplication::createSwapChain()
{
    ...
    QueueFamilyIndices indices = findQueueFamilies(m_PhysicalDevice, m_Surface);
    uint32_t queueFamilyIndices[] = { (uint32_t)indices.graphicsAndComputeFamily.value(), (uint32_t)indices.presentFamily.value() };
...
{
    auto computeShaderCode = ToyUtils::readFile("comp.spv");
...
void HelloTriangleApplication::recordComputeCommandBuffer(VkCommandBuffer commandBuffer)
{
    ...
    vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_COMPUTE, m_ComputePipelineLayout,
...
void HelloTriangleApplication::createSyncObjects()
{
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i)
    {
        if (vkCreateSemaphore(m_Device, &semaphoreInfo, nullptr, &m_ImageAvailableSemaphore[i]) != VK_SUCCESS ||
            ...
            throw std::runtime_error("Failed to create graphics synchronization for a frame!");
...
void HelloTriangleApplication::drawFrame()
{
    ...
    VkSemaphore waitSemaphores[] = { m_ComputeFinishedSemaphores[m_CurrentFrame], m_ImageAvailableSemaphore[m_CurrentFrame] };
